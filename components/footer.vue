                ...
                <div class="row justify-content-between">     
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-menu footer-menu-1">
                            ...
                            <ul>
                                <li><a href="contact.html#">Content Marketing</a></li>
                                <li><a href="contact.html#">Email Marketing</a></li>
                                <li><a href="contact.html#">Facebook Marketing</a></li>
                                <li><a href="contact.html#">NFT Marketing</a></li>
                                <li><a href="contact.html#">Affiliate Marketing</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-menu footer-menu-1">
                            ...
                            <ul>
                                <li><a href="contact.html#">Popular Articles</a></li>
                                <li><a href="contact.html#">Dynamic Tool</a></li>
                                <li><a href="contact.html#">Keyword Generate</a></li>
                                <li><a href="contact.html#">News & Case</a></li>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-menu footer-menu-1">
                            ...
                            <ul>
                                <li><a href="contact.html#">SEO Content Strategy</a></li>
                                <li><a href="contact.html#">Blog Website</a></li>
                                <li><a href="contact.html#">Ecommerce Website</a></li>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-menu footer-menu-2">
                            ...
                            <ul>
                                <li><a href="contact.html#">Success Stories</a></li>
            ...
            <div class="footer-support">
                <div class="footer-call">
                    ...
                    <span class="font-size-1-20">
                        Contact us at <a href="contact.html#">@Example.com
                        </a>
                    </span>
                </div>
            ...
            <div class="footer-copyright">
                ...
                <div class="footer-copyright-social-icon">
                    <ul>
                        ...
                        <li><a href="contact.html#"><i class="fa-brands fa-vimeo-v"></i></a></li>
                        <li><a href="contact.html#"><i class="fa-brands fa-pinterest"></i></a></li>
                    </ul>
                </div>
                <div class="footer-privecy-policy">
                    <a href="contact.html#" class="font-size-1-18">Terms of Use</a>
                    <span class="font-size-1-18">|</span>
                    <a href="contact.html#" class="font-size-1-18">Privacy Policy</a>
                </div>
            </div>
        </div>
    </section>
